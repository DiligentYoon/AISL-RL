...
class Critic(Model):
    ...
    def forward(self, states: torch.Tensor, deterministic: bool = False, update_rms: bool = False):
        """
        ...
        standardized_input = self.critic_standardizer.standardize(states, update=update_rms)
