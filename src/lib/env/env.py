# References: (https://github.com/isaac-sim/IsaacLab/blob/main/CONTRIBUTORS.md).
# All rights reserved.
#
...
class Env(gym.Env):
    """The superclass to design reinforcement learning environments.

    This class implements the core functionality for reinforcement learning (RL)
    environments. The class is designed to be used with vectorized environments, 
    i.e., the environment is expected to be run in parallel with multiple sub-environments.
    ...
    def __init__(self, cfg: EnvCfg, render_mode: str | None = None, **kwargs):
        ...
        if self.cfg.seed is not None:
            ...
            self.cfg.seed = self.seed(42)
            logger.warning("Seed not set for the environment. Default Seed is applied.")
    ...
    def step_dt(self) -> float:
        ...
        """
        return self.cfg.sim.dt * self.cfg.decimation * self.cfg.decimation_apply
