...
from lib.assets.robots.GOAT.PF_GOAT.PF_GOAT import GOAT_CFG
...
class PFGOATBaseEnvCfg(EnvCfg):
    ...
    # sensor
    contact_sensors = ContactSensorCfg(prim_path="/World/envs/env_.*/Robot/.*", history_length=3, track_air_time=True)
