...
class G1BasicLocomotionEnv(G1BaseEnv):
    ...
    def _setup_scene(self):
        ...
        if self.device == "cpu":
            self.scene.filter_collisions(global_prim_paths=[self.cfg.terrain_importer_cfg.prim_path])
        # add lights
    ...
    def _compute_intermediate_values(self):
        ...
        self.velocity, self.ang_velocity = self._robot.data.root_lin_vel_w, self._robot.data.root_ang_vel_w
        self.dof_pos, self.dof_vel = self._robot.data.joint_pos, self._robot.data.joint_vel
...
def compute_rewards(
    ...
    # aligning up axis of _robot and environment
