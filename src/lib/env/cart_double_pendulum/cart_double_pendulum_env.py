...
class CartDoublePendulumEnv(Env):
...
def compute_rewards(
    ...
    cart_reward = rew_alive + rew_termination + rew_pole_pos + rew_cart_vel + rew_pole_vel
    pendulum_reward = rew_alive + rew_termination + rew_pendulum_pos + rew_pendulum_vel

    total_reward = torch.stack((cart_reward, pendulum_reward), dim=-1)
