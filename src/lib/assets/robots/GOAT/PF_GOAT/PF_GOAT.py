...
PF_GOAT_ASSET = {
    "urdf_path": os.path.join(current_dir, "urdf/PF_GOAT.urdf"),
    "usd_path": os.path.join(current_dir, "usd/PF_GOAT.usd"),
    "usd_place": os.path.join(current_dir, "usd/"),
    "usd_filename": "PF_GOAT.usd"
}

# URDF to USD conversion
urdf_cfg: sim_utils.UrdfConverterCfg = sim_utils.UrdfConverterCfg(
    root_link_name = "base_Link",
    asset_path = PF_GOAT_ASSET["urdf_path"],
    usd_dir = PF_GOAT_ASSET["usd_place"],
    usd_file_name = PF_GOAT_ASSET["usd_filename"],
    fix_base=False,
...
if urdf_converter.usd_path == PF_GOAT_ASSET["usd_path"]:
...
GOAT_CFG: ArticulationCfg = ArticulationCfg(           
    ...
    # Link = ['base_Link', 'hip_L_Link', 'hip_R_Link', 'thigh_L_Link', 'thigh_R_Link', 'calf_L_Link', 'calf_R_Link']
    # Joint = ['hip_L_Joint', 'hip_R_Joint', 'thigh_L_Joint', 'thigh_R_Joint', 'knee_L_Joint', 'knee_R_Joint']
